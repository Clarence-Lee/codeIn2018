    ...
    public static void main(String[] args) {
        ...
        for (int i = 0 ; i < lineList.size(); i++) {
            ...
            for (int j = i + 1; j < lineList.size(); j++) {
                if (lineList.get(i).getECen().equals(lineList.get(j).getECen()) &&
                        ...
                        lineList.get(i).getTType().equals(lineList.get(j).getTType()) && lineList.get(i).equals("9.6m")) {
                    isSame = true;
                    break;
                }
            }
        ...
        for (int i = 0 ; i < lineList.size(); i++) {
            ...
            for (int j = i + 1; j < lineList.size(); j++) {
                ...
                for (int k = i + 1; j < lineList.size(); j++) {
                    if (lineList.get(i).getECen().equals(lineList.get(k).getECen()) &&
                            lineList.get(i).getSCen().equals(lineList.get(k).getSCen()) &&
                            lineList.get(i).getTType().equals(lineList.get(k).getTType()) && lineList.get(i).equals("9.6m")) {
                        isSameB = true;
                        break;
                    }
                }
            ...
            for (int j = i+1; j < lineList.size(); j++) {
                if (isSameA && lineList.get(i).getECen().equals(lineList.get(j).getSCen()) &&
                        lineList.get(i).getSCen().equals(lineList.get(j).getECen())){
                    System.out.println("rule1:"+lineList.get(i).getId() + "+" + lineList.get(j).getId());
                } else if (lineList.get(i).getSCen().equals(lineList.get(j).getECen()) &&
                        lineList.get(i).getECen().equals(lineList.get(j).getSCen()) &&
